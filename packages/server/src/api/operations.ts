...
export function registerOperationRoutes(
  ...
  async function planCompositeChildren(
    ...
    debrief.record({
      ...
      agent: "server",
      decisionType: "composite-started" as Parameters<typeof debrief.record>[0]["decisionType"],
        ...
        if (result.blocked) {
          ...
          if (parentDep && parentDep.status === "pending") {
            ...
            debrief.record({
              ...
              agent: "server",
              decisionType: "composite-failed" as Parameters<typeof debrief.record>[0]["decisionType"],
    ...
    if (!anyFailed) {
      ...
      if (parentDep && parentDep.status === "pending") {
        ...
        debrief.record({
          ...
          operationId: parentDep.id,
          agent: "server",
          decisionType: "composite-plan-ready" as Parameters<typeof debrief.record>[0]["decisionType"],
